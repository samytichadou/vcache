...
#            row.prop(self, "cache_vr_video_format", expand=False)
        ...
        if self.pref_infos==True:
            ...
            row=box.row()
            col=row.column()
            col.label('Pie Menu --- alt + Y')
            col=row.column()
            col.label('Toggle Caching --- ctrl + Y')
            col=row.column()
            col.label('Cache and Play --- ctrl + alt + Y')
            row=box.row()
            col=row.column()
            col.label('Go to Next Cache slot --- ctrl + shift + I')
            col=row.column()
            col.label('Go to Previous Cache slot --- ctrl + shift + U')
